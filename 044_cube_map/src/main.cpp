...
static int ShowWindow() {
    ...
    petalThread.detach();
    petalModel = new Model{FileSystem::getPath(R"(resources/model/petal/new_petal1.obj)")};
    InitPetalObjs();
...
static void InitPetalObjs() {
    ...
    // roseModel = new Model{FileSystem::getPath(R"(resources/model/rose/rose1.obj)")};
    roseModel = new Model{FileSystem::getPath(R"(resources/model/rose/rose_advanced.obj)")};
    // roseModel = new Model{FileSystem::getPath(R"(resources/model/rose/heart1.obj)")};
