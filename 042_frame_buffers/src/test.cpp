...
int main() {
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, kScrWidth, kScrHeight, 0, GL_RGB, GL_UNSIGNED_BYTE, NULL);
    ...
    glRenderbufferStorage(GL_RENDERBUFFER, GL_DEPTH24_STENCIL8, kScrWidth, kScrHeight); // use a single renderbuffer object for both a depth AND stencil buffer.
